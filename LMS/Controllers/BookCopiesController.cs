...
namespace LMS.Controllers
{
    public class BookCopiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,BookID,Available")] BookCopy bookCopy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,BookID,Available")] BookCopy bookCopy)
        {
            if (ModelState.IsValid)
            {
