...
namespace LMS.Controllers
{
    public class BooksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,ISBN,PublisherID,PublishedDate,Charge,PenaltyCharge")] Book book, string[] selectedAuthors, string[] selectedCategories)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,ISBN,PublisherID,PublishedDate,Charge,PenaltyCharge")] Book book, string[] selectedAuthors, string[] selectedCategories)
        {
